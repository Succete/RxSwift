...
extension Collection where Iterator.Element : DriverConvertibleType {
    ...
    */
    @warn_unused_result(message:"http://git.io/rxs.uo")
    public func zip<R>(_ resultSelector: ([Iterator.Element.E]) throws -> R) -> Driver<R> {
...
extension Collection where Iterator.Element : DriverConvertibleType {
    ...
    */
    @warn_unused_result(message:"http://git.io/rxs.uo")
    public func combineLatest<R>(_ resultSelector: ([Iterator.Element.E]) throws -> R) -> Driver<R> {
