...
public class SerialDispatchQueueScheduler: SchedulerType {
    ...
    */
    ...
    public convenience init(globalConcurrentQueueQOS: DispatchQueueSchedulerQOS, internalSerialQueueName: String = "rx.global_dispatch_queue.serial") {
        ...
        self.init(queue: DispatchQueue.global(attributes: DispatchQueue.GlobalAttributes.init(rawValue: UInt64(priority.rawValue))), internalSerialQueueName: internalSerialQueueName)
    }
