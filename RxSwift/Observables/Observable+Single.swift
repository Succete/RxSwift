...
extension ObservableType {
    ...
    */
     ...
     */
    @warn_unused_result(message:"http://git.io/rxs.uo")
    public func doOnNext(_ onNext: ((E) throws -> Void))
        -> Observable<E> {
     ...
     */
    @warn_unused_result(message:"http://git.io/rxs.uo")
    public func doOnError(_ onError: ((ErrorProtocol) throws -> Void))
        -> Observable<E> {
     ...
     */
    @warn_unused_result(message:"http://git.io/rxs.uo")
    public func doOnCompleted(_ onCompleted: (() throws -> Void))
        -> Observable<E> {
