...
extension Collection where Iterator.Element : ObservableType {
    ...
    */
    ...
    public func combineLatest<R>(_ resultSelector: ([Iterator.Element.E]) throws -> R) -> Observable<R> {
...
extension Collection where Iterator.Element : ObservableType {
    ...
    */
    @warn_unused_result(message:"http://git.io/rxs.uo")
    public func zip<R>(_ resultSelector: ([Iterator.Element.E]) throws -> R) -> Observable<R> {
...
extension Swift.Sequence where Iterator.Element : ObservableType {
